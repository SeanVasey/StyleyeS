...
[![Version](https://img.shields.io/badge/Version-2.2.3-00D4AA?style=for-the-badge)](CHANGELOG.md)
...
├── styleyes-icon-ios.svg   # Branded app tile — favicon + iOS/PWA home screen
├── icons/
│   ├── StyleyeS_icon_optimized.svg # Transparent app logo (in-app header)
│   ├── icon-*.png          # Favicon & PWA raster icons (rendered from the tile)
│   ├── icon-maskable-*.png # Maskable icons for Android (full-bleed)
│   ├── apple-touch-icon-*.png # iOS home screen icons (opaque)
